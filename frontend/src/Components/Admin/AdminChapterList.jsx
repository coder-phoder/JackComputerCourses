            ...
            >
              <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 break-all text-sm text-slate-500">{chapter.playlistUrl}</p>
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-2">
                  {videos.map((video) => (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3 transition hover:border-indigo-200 hover:bg-white"
                    >
                      {video.thumbnailUrl ? (
                        <img
