      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold text-slate-900">All Faculties</h1>
          </div>
          <button
            type="button"
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,380px)_1fr]">
            ...
            {editingFaculty ? (
              <>
                ...
                <form onSubmit={handleUpdateFaculty} className="mt-6 space-y-4">
                  <div>
                    <label htmlFor="edit-faculty-name" className="block text-sm font-medium text-slate-700">
                      Name
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor="edit-faculty-phone" className="block text-sm font-medium text-slate-700">
                      Phone
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor="edit-faculty-password" className="block text-sm font-medium text-slate-700">
                      New Password
                    </label>
                    <input
              ...
              <>
                ...
                <form onSubmit={handleCreateFaculty} className="mt-6 space-y-4">
                  <div>
                    <label htmlFor="create-faculty-name" className="block text-sm font-medium text-slate-700">
                      Name
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor="create-faculty-phone" className="block text-sm font-medium text-slate-700">
                      Phone
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor="create-faculty-password" className="block text-sm font-medium text-slate-700">
                      Password
                    </label>
                    <input
          ...
          <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
              <h2 className="text-lg font-bold text-slate-900">Faculties</h2>
                ...
                <table className="min-w-full divide-y divide-slate-200">
                  ...
                  <tbody className="divide-y divide-slate-200 bg-white">
                    {sortedFaculties.map((faculty) => {
                      ...
                      return (
                        <tr key={faculty._id} className={isEditing ? 'bg-indigo-50/40' : undefined}>
