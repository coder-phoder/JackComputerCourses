      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <PageTour steps={adminFacultiesPageTour} />
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,380px)_1fr]">
          <section data-tour="admin-faculty-form" className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
            {editingFaculty ? (
              <>
          ...
          <section data-tour="admin-faculty-table" className="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
                      ...
                      return (
                        <tr key={faculty._id} className={isEditing ? 'bg-indigo-50/40 dark:bg-indigo-950/30' : undefined}>
                          ...
                          <td className="px-6 py-4 align-top">
                            ...
                            <div
                              data-tour={index ? undefined : 'admin-faculty-actions'}
